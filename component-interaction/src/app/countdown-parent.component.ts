import { AfterContentInit, AfterViewInit, ContentChild, ViewChild } from '@angular/core';
...
export class CountdownContentChildParentComponent implements AfterContentInit {
  ...
  ngAfterContentInit(): void {
    // Not need for a tick to avoid one-time devMode
    // No unidirectional-data-flow-violation error
    this.seconds = () => this.timerComponent.seconds;
  }
